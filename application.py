...
class Vectorizer:
    ...
    def get_wordList(self):
        wordListFile=open("wordList.txt",'r',encoding='utf-8')
...
svm_linear=joblib.load(open('linearPickle.pkl','rb'))
svm_rbf=joblib.load(open('rbfPickle.pkl','rb'))
random_forest=joblib.load(open('randomForestPickle.pkl','rb'))

article=input("Enter Article :\t")
x_vectorized=vectorizer.transform_article(article)
y_pred=svm_linear.predict(x_vectorized)
print(vectorizer.get_category(y_pred))
